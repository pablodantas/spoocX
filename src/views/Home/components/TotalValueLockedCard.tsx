...
import { Card, CardBody, Heading, Skeleton, Text } from 'jetswap-uikit-new'
...
const TotalValueLockedCard = () => {
  ...
  return (
    <StyledTotalValueLockedCard>
      <CardBody>
        <Heading size="lg" color="white" mb="14px">
        ...
        {data ? (
          <>
            <Heading fontSize="32px" size="lg" color="#fff">{`$${tvl}`}</Heading>

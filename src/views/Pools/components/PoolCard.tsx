...
import { Button, IconButton, useModal, AddIcon, Image } from 'jetswap-uikit-new'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  const symbol = useMemo(() => {
    return [0, 1, 2, 15].includes(sousId) ? stakingToken.symbol : earningToken.symbol

...
import { Flex, Text, Skeleton } from 'jetswap-uikit-new'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, wingsPrice, account }) => {
  ...
  return (
    <FCard>
      {['WINGS', 'FUEL', 'FTS', 'GFCEv2'].includes(farm.token.symbol) && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      {!removed && (
        <Flex justifyContent="space-between" alignItems="center">
          ...
          <Text bold style={{ display: 'flex', alignItems: 'center' }}>
            {farm.apy ? (
              <>
                <ApyButton lpLabel={lpLabel} addLiquidityUrl={addLiquidityUrl} wingsPrice={wingsPrice} apy={farm.apy} />
                {farmAPY}%
              </>
            ) : (

...
import { useWings, useBunnyFactory } from 'hooks/useContract'
...
const Mint: React.FC = () => {
  ...
  const {
    ...
    onRequiresApproval: async () => {
      ...
      try {
        const response = await wingsContract.methods.allowance(account, bunnyFactoryContract.options.address).call()

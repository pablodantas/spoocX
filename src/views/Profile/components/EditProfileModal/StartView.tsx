...
import { Button, Flex, Text, InjectedModalProps } from 'jetswap-uikit-new'
import { getFullDisplayBalance } from 'utils/formatBalance'
import { getPancakeProfileAddress } from 'utils/addressHelpers'
import { useWings } from 'hooks/useContract'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  useEffect(() => {
    const checkApprovalStatus = async () => {
      const response = await wingsContract.methods.allowance(account, getPancakeProfileAddress()).call()
  ...
  }, [account, cost, setNeedsApproval, wingsContract])

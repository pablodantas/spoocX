...
import { Heading, Text, Flex, ChevronRightIcon } from 'jetswap-uikit-new'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">{t('Pancake Collectibles are special ERC-721 NFTs that can be used on the JetSwap platform.')}</Text>
      <Text as="p">

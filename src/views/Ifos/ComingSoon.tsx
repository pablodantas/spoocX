  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">Coming Soon to JetSwap.</Title>
            <Text mb={3}>
            ...
            <Text mb={3}>
              <LiquidityLink href="https://exchange.jetswap.finance/#/add/BNB/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56">
                Get BUSD
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              The project gets the BNB, Jetswap burns the WINGS.
              <br />
          ...
          <Block>
            ...
            <Text mb={3}>
              Launch your project with JetSwap, Binance Smart Chain’s most-used AMM project and liquidity provider, to
              bring your token directly to the most active and rapidly growing community on BSC.
            </Text>
            <Button
              as="a"

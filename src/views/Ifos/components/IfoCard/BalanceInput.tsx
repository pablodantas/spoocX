...
import { Button, Box, BoxProps, Flex, Input as UIKitInput, Text } from 'jetswap-uikit-new'
  ...
  return (
    <StyledBalanceInput {...props}>
      ...
      <Flex alignItems="center" justifyContent="space-between">
        <Input onChange={onChange} placeholder="0" value={value} style={{ marginRight: '10px' }} />
        {onSelectMax && (

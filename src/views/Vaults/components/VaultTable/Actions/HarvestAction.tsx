...
import { Button } from 'jetswap-uikit-new'
...
import { usePriceWingsBusd, useGetApiPrices } from 'state/hooks'
...
const HarvestAction: React.FunctionComponent<VaultWithStakedValue> = ({ pid, userData, ...props }) => {
  ...
  return (
    <ActionContainer>
      ...
      <ActionContent>
        ...
        <Tooltip
          content={t(
            'Users who call the compound button will call the contract for everyone in the vault contract. You will receive 0.5% of the entire compound as a wbnb reward to compensate for your gas costs',
          )}
        >
          <Button

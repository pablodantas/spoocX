...
const VaultCard: React.FC<VaultCardProps> = ({ vault, removed, wingsPrice, account }) => {
  ...
  const earnLabel = vault.lpSymbol // vault.dual ? vault.dual.earnLabel : 'WINGS  '
  ...
  return (
    <FCard>
      {['WINGS', 'FUEL', 'FTS', 'GFCEv2'].includes(vault.token.symbol) && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}

...
import { Button, Heading, Won, useModal } from 'jetswap-uikit-new'
...
const PrizesWonContent: React.FC<PrizesWonContentProps> = ({ winnings, tickets, rewardTicketIds }) => {
  ...
  const { onClaimReward } = useClaimReward(currentLotteryNumber)
  ...
  return (
    <StyledCardContentInner>
      ...
      <div>
        <IconWrapper>
          <img src="/images/assets/win.svg" alt="win" width={100} />
        </IconWrapper>
